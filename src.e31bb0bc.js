...
var CONTRACT_NAME = "dev-1650299772082-54462800538872" || 'dev-1637427930587-41867732244545';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/vlodkow", "/.near/validator_key.json"),
...
var submitButton = document.getElementById('callContract');
var nameButton = document.getElementById('nameButton');
var resultBlock = document.getElementById('resultText');
var helloImage = document.getElementById('helloImage');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return window.contract.get_greeting({
              account_id: nameButton.value
            });

          case 5:
            greeting = _context.sent;
            resultBlock.innerHTML = "<b>".concat(greeting, "</b>, I'm NEAR blockchain.");
            _context.next = 12;
            break;
...
helloImage.onclick = /*#__PURE__*/function () {
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
